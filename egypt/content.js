...
/* Quoted from the Victorian Curriculum 2.0 History sub-strand "Using
   historical sources". These descriptors are about the skill, not the topic,
   so they are identical to unit 1's — that is correct, not a copy-paste slip.
   The document runs Foundation to Level 6 only. */
const VC = {
 "Foundation to Level 2": [
