...
"Year 6":
`GS73 is an {source|archaeological artefact}: a {source|sandstone grinding-stone fragment} found at Madjedbebe on Mirarr Country. Photographs show {source|grooves and polish}. It belongs to {context|a very early period of Aboriginal occupation}, when people repeatedly used stone tools. Some researchers {evidence|place Phase 2 at about 65,000 years ago}, while others {evidence|question whether soil movement affected that date}. It is {judge|useful evidence that people ground materials}, although the stone alone {judge|cannot identify exactly what was ground}. Before writing, I {meta|broke the task into source, context, interpretations and usefulness}.`,

"Year 7":
`The ancient source is GS73, {source|a sandstone millstone fragment} excavated from {source|Phase 2 at Madjedbebe on Mirarr Country}. The modern record is {source|a 2022 scientific figure by Hayes and colleagues}, created to document its wear and residues and {source|argue for long-term grinding-stone use}. In ancient Australia, grinding technology {context|helped people prepare hard or fibrous plant foods} and shows {context|detailed knowledge of local resources}. Hayes and colleagues {evidence|interpret plant processing} because the source contains {evidence|deep grooves, microscopic polish, 41 starch grains and plant-related compounds}; other researchers {evidence|question the earliest date of the layer}. GS73 is {judge|highly useful for investigating plant processing} because {judge|shape, wear and residues agree}, but {judge|the exact plant is unidentified} and {judge|the precise age remains contested}. After reviewing, I {meta|changed ‘proves’ to ‘supports’} and {meta|separated the well-supported function from the disputed date}.`,

"Year 8":
`The ancient source is GS73, {source|a millstone fragment} from {source|Phase 2}; Hayes and colleagues’ {source|2022 scientific figure records its form, wear and residues} so readers can examine their interpretation. Madjedbebe is {context|a long-occupied site on Mirarr Country}, and the grinding evidence places {context|complex plant preparation within deep Aboriginal history}. Hayes {evidence|interpret seed grinding from wear and residues}; Clarkson {evidence|defend the early context using site integrity and dating}; and Williams use {evidence|termite and sediment evidence to make the precise age less secure}. {judge|Shape, microscopic wear, starch and plant compounds} strengthen the function claim, but I would ask: {judge|Could contamination affect the residues? Could layer movement affect the date?} I reflected by {meta|checking which methods added independent support} and {meta|recording the questions still unresolved}.`,

"Year 9":
`GS73 is {source|material evidence} excavated from {source|a recorded Phase 2 context}. The {source|peer-reviewed 2022 figure} combines {source|photographs, micrographs and laboratory results} to {source|persuade a scientific audience} that grinding-stone use has a deep history. The study belongs to {context|research into the deep Aboriginal history of Sahul} and was conducted {context|with permission from Mirarr custodians}. Hayes use {evidence|grooves, polish and residues to argue for seed processing}; Clarkson use {evidence|site integrity and dating to support the early chronology}; while Williams use {evidence|termite and sediment evidence to challenge it}. Agreement between wear and residue evidence {judge|makes grinding the strongest claim}, while the exact plant and precise age {judge|are weaker because they depend on preservation and depositional context}. I {meta|monitored whether I was comparing evidence or merely listing it}, then {meta|rewrote the list as a judgement}.`,

"Year 10":
`GS73 is an ancient artefact interpreted through a modern scientific publication. Its explicit evidence is {source|recorded wear and residues}; its implicit argument is that {source|grinding technology has a deeper Australian history than older accounts allowed}, aimed at {source|archaeologists and other scientific readers}. The investigation reflects {context|contemporary scientific testing and collaboration with Mirarr custodians}, revealing values of {context|empirical testing, custodial permission and careful qualification}. Hayes and Clarkson {evidence|accept the early context because several records converge}, while Williams {evidence|gives more weight to termite disturbance and sediment movement}; their interpretations differ because they make {evidence|competing judgements about site formation}. Overall, GS73 is {judge|strong evidence for grinding but only qualified evidence for an exact age}: strengths include {judge|converging methods}; limitations include {judge|unidentified starch, contamination and contested layer history}. I {meta|justified triangulation as the strongest strategy}, then {meta|adapted the conclusion because the claims have different certainty}.`
};
